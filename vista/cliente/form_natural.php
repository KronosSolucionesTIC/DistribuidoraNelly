                <div id="divNatural">
                    <div class="row">
                        <div class="alert alert-secondary text-center" role="alert">
                          <strong>Datos cliente natural</strong>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                          ...
                          <div class="mb-2">
                            <div class="form-floating">
                              <select class="form-select" id="tipo_empleo_cli" name="tipo_empleo_cli">
                                <?php $clienteController->getSelectTipoEmpleado();?>
                              </select>
                          ...
                          <div class="mb-2">
                            <div class="form-floating">
                              <select class="form-select" id="ciudad_cli" name="ciudad_cli">
                                <?php $clienteController->getSelectCiudad();?>
                              </select>
                          ...
                          <div class="mb-2">
                            <div class="form-floating">
                              <select class="form-select" id="cod_mismo_paciente" name="cod_mismo_paciente">
                                <?php $clienteController->getSelectSiNo();?>
                              </select>
                              <label for="floatingSelect">¿Cliente es el mismo paciente?</label>
                            </div>
                          </div>
                        </div>
                    </div>
